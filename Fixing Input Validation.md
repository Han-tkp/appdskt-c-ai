...
พอดีฉันไปแก้มา ช่วยตรวจสอบหน่อย พร้อม Refactor code เพราะตอนนี้เปิดกล้องไม่ได้บนกล้องจุลทรรศ แต่พอเป็นกล้องที่ติดกับโน็ตบุค ดันเปิดได้ ช้วยตรวจหน่อย 
...
*Viewed [MainWindowViewModel.Actions.cs](file:///c:/Users/h4n/Desktop/app-new12-2/DropDetect/ViewModels/MainWindowViewModel.Actions.cs) *
...
โอเคงั้นตอนนี้ช่วยรีวิวสิ่งที่ฉันแก้เองมาหน่อย ทั้งโปรเจค ว่าจุดไหนอีกไหมที่บกพร่อง 
โดยสิ่งที่ฉันเคยเจอ และได้แก้ไปแล้ว 
ส้วนของ snapshot มีปัญหา 
-กดตามคีลัดไม่ได้ เมื่อเลือกโหมด snapshot แล้ว 
-เมื่อตั้งหรือเปลีย่นคีลัดเป็น spacebar เมื่อกดมนจะเข้าหน้า setting
-ส่วนของการ snapshot อยากให้มีการตั้งค่าส่วนเฉพาะ ของ snapshot แยกไปเลยใน setting โดยจะอยู่ใน AI Setting สามารถตั้งค่า 
1เวลาการแสดงผลของ Label ตัวละอองเม็ดน้ำยา เป็นการกรอกตัวเลขแทน การเลือกแบบเดิม
2ปุ่ม คีลัด 
-การเพิ่มจำนวนละอองต่อ สไลด์ ในหน้า report ควรที่จะสามารถเพิ่มต่อได้ 
...
ฉันว่าตรงการปรับ MS เป็นการปรับแบบ หน่วย วิ ไปเลยดีกว่า เช่น 3วิ จะดีกว่าการต้องมาปรับแบบ MS ที่ต้องป้อน 500 or 3000
...
ส่วนของหน้า Setting ช่วยทำการ lock size ไม่ก็ทำ Responsive หน่อย 
...
*User accepted the command `taskkill /IM Detectvbdc12.2.exe /F`*

*User accepted the command `taskkill /PID 8100 /F`*

*Checked command status*

### User Input

แก้ส่วนของนี้ดีกว่า ของพวกการกรอกที่เมื่อลบข้อความออกหมดหรือไม่มี test or nuberic ควรจะแสดงข้อความว่า กรุณนาป้อน และช่วยเช็คจุดอื่นๆด้วย ทั้งระบบว่ามีจุดไหน ที่จะทำให้มันเพี้ยน และแสดงความคิดเห็นด้วย 
